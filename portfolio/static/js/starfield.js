...
class App {
    ...
    */
    renderStar(star, id) {
        return new Promise(resolve => {
            starFieldEl.insertAdjacentHTML('afterbegin', `<div id="star-${id}" class="star" style="transition: all ${star.speed}s linear; transform: translate3d(${star.startX}vw, ${star.startY}vh, 1px)"></div>`);
   ...
   moveStar(star, id, el) {
        ...
        starEl.style.transform = `translate3d(${star.finishX}vw, ${star.finishY}vh, 100px)`;
